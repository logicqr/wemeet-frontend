    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between z-20 p-12">
          ...
          <div className="mb-16">
            <h2 className="text-white text-4xl font-bold mb-6">Simplify your HR operations</h2>
            <p className="text-blue-100 text-xl mb-8">Seamless attendance tracking, employee management, and HR analytics in one place</p>
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-blue-100">Join thousands of companies using WebzSpot</span>
            </div>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-center mt-6">
              <div className="text-sm">
                <a href="/login" className="font-medium text-blue-600 hover:text-blue-500 flex items-center">
