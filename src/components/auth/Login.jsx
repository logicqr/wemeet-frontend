      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between z-20 p-12">
          <div className="flex items-center">
            ...
            <h1 className="text-white text-2xl font-bold ml-3">WebzSpot HRMS</h1>
          </div>
          
          <div className="mb-16">
            <h2 className="text-white text-4xl font-bold mb-6">Welcome back</h2>
            <p className="text-blue-100 text-xl mb-8">Access your HR portal to manage attendance, leave requests, and more</p>
            <div className="flex items-center space-x-3">
            <div className="flex -space-x-2">
                <img className="inline-block h-10 w-10 rounded-full ring-2 ring-white object-cover" src="https://ik.imagekit.io/pds5n5l6d3/LogicQR/Profiles/medium-shot-smiley-man-posing.jpg?updatedAt=1741542639142" alt="User"/>
                <img className="inline-block h-10 w-10 rounded-full ring-2 ring-white object-cover" src="https://ik.imagekit.io/pds5n5l6d3/LogicQR/Profiles/stylish-handsome-indian-man-tshirt-pastel-wall.jpg?updatedAt=1741541251874" alt="User"/>
                <img className="inline-block h-10 w-10 rounded-full ring-2 ring-white object-cover" src="https://ik.imagekit.io/pds5n5l6d3/LogicQR/Profiles/eastern-woman.jpg?updatedAt=1741541236840" alt="User"/>
              </div>
              <span className="text-sm text-blue-100">Join thousands of professionals using WebzSpot</span>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-2">Access your WebzSpot HRMS portal</p>
          </div>
          
          {error && (
            <div className="mt-6 flex items-center p-4 mb-6 text-sm text-red-800 border-l-4 border-red-500 bg-red-50" role="alert">
          ...
          {success && (
            <div className="mt-6 flex items-center p-4 mb-6 text-sm text-green-800 border-l-4 border-green-500 bg-green-50" role="alert">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-center mt-6">
              <div className="text-sm">
                ...
                <a href="/register" className="font-medium text-blue-600 hover:text-blue-500 ml-2">
                  Register now
                </a>
              </div>
            </div>
            ...
            <div className="flex justify-center space-x-6">
              <button className="flex items-center px-4 py-2 text-sm text-gray-700 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
                <svg className="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22.56 12.25C22.56 11.47 22.49 10.72 22.36 10H12V14.26H17.92C17.66 15.63 16.88 16.79 15.68 17.57V20.13H19.12C21.16 18.24 22.56 15.49 22.56 12.25Z" fill="#4285F4"/>
                  <path d="M12 23C14.97 23 17.46 22.02 19.12 20.13L15.68 17.57C14.7 18.23 13.45 18.63 12 18.63C9.05 18.63 6.57 16.64 5.73 13.97H2.19V16.61C3.84 20.43 7.62 23 12 23Z" fill="#34A853"/>
                  <path d="M5.73 13.97C5.5 13.31 5.37 12.59 5.37 11.84C5.37 11.09 5.5 10.37 5.73 9.71V7.07H2.19C1.46 8.51 1 10.14 1 11.84C1 13.54 1.46 15.17 2.19 16.61L5.73 13.97Z" fill="#FBBC05"/>
                  <path d="M12 5.05C13.65 5.05 15.14 5.63 16.32 6.77L19.36 3.73C17.46 1.93 14.97 0.81 12 0.81C7.62 0.81 3.84 3.38 2.19 7.2L5.73 9.84C6.57 7.17 9.05 5.05 12 5.05Z" fill="#EA4335"/>
                </svg>
                Sign in with Google
              </button>
