...
import { FaMapMarkerAlt, FaRuler, FaCheckCircle, FaExclamationTriangle, 
  FaLink, FaMapPin, FaCrosshairs, FaInfoCircle, FaLocationArrow, 
  FaCog, FaGlobeAmericas, FaBuilding, FaArrowRight } from 'react-icons/fa';
...
export default function LocationSettingsForm() {
  ...
  const extractCoordinatesFromLink = () => {
    ...
    try {
      ...
      let match = googleMapsLink.match(atPattern) || 
      ...
      setError("Invalid Google Maps link. Please make sure it contains coordinates.");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put('https://wemeet-backend-latest.onrender.com/api/settings', {
        ...submissionData,
      ...
      return (
        <div className="h-full flex items-center justify-center bg-gray-100 rounded-xl">
          <div className="text-center p-6">
            ...
            <p className="text-gray-500 font-medium">Enter location coordinates to preview</p>
            <p className="text-gray-400 text-sm mt-2">Map preview will appear here</p>
          </div>
        </div>
      );
    }
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-white bg-opacity-90 p-3">
          <div className="text-sm">
            <div className="font-medium">
              {placeName || "Office Location"}
            </div>
            <div className="text-gray-600 text-xs flex justify-between">
              <span>{formData.officeLatitude}, {formData.officeLongitude}</span>
      ...
      <main className="flex-grow py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-screen-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-gray-500">Configure your office location and check-in parameters</p>
          </div>
              ...
              <div className="border-b border-gray-200">
                <div className="px-4 py-3">
                  <div className="flex items-center">
                    ...
                    <h3 className="text-md font-medium text-gray-900">Location Preview</h3>
                  </div>
                </div>
              </div>
                ...
                <div className="border-b border-gray-200">
                  <div className="px-6 py-5">
                    <div className="flex items-center">
                      ...
                      <h3 className="text-lg font-medium text-gray-900">Office Location Details</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  {success && (
                    <div className="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-md flex items-start animate-fadeIn">
                      ...
                      <p className="text-green-700 text-sm">Settings saved successfully! Your location has been updated.</p>
                    </div>
                  )}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <label className="block text-sm font-medium text-gray-700">Google Maps Location Link</label>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
                          ...
                          Right-click on your office location in Google Maps and select "Copy link"
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Coordinates Section */}
                    <div className="space-y-4">
                      <label className="block text-sm font-medium text-gray-700">Office Coordinates</label>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1">
                          <div className="text-xs font-medium text-gray-500">Latitude</div>
                          <input
                            type="text"
                            name="officeLatitude"
                        ...
                        <div className="space-y-1">
                          <div className="text-xs font-medium text-gray-500">Longitude</div>
                          <input
                            type="text"
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <label className="block text-sm font-medium text-gray-700">Check-in Radius</label>
                        <div className="relative">
                          ...
                          {showTooltip && (
                            <div className="absolute right-0 transform translate-y-1 w-64 bg-gray-800 text-white text-xs p-3 rounded-lg shadow-lg z-10">
                              This is the maximum distance (in meters) from the office location where employees can check in.
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          {radiusOptions.map(option => (
                            <option key={option} value={option}>{option} meters</option>
                          ))}
                        </select>
                        ...
                        <div className="space-y-2">
                          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${(formData.allowedRadius / Math.max(...radiusOptions)) * 100}%` }}
                            ></div>
                          </div>
                    ...
                    <div className="pt-4">
                      ...
                      >
                        ...
                        {loading ? "Saving Changes..." : "Update Location Settings"}
                      </button>
                    </div>
                    ...
                    <div className="text-center mt-4 px-6">
                      <p className="text-xs text-gray-500">
                        Location data is securely stored and only used for employee check-in verification.
                      </p>
                    </div>
                  </form>
                </div>
                  ...
                  <div className="border-b border-gray-200">
                    <div className="px-6 py-5">
                      <div className="flex items-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-900">Location Preview</h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    <ul className="space-y-4">
                      <li className="flex items-start">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-gray-700">Employees must be physically present within the specified radius to check in.</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-5 w-5 text-blue-500 mt-0.5">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-gray-700">GPS coordinates are automatically verified during check-in.</p>
                        </div>
                      </li>
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-5 w-5 text-blue-500 mt-0.5">
                        ...
                        <div className="ml-3">
                          <p className="text-sm text-gray-700">Consider local geography when setting the radius (buildings, landscapes can affect GPS accuracy).</p>
                        </div>
                      </li>
                    </ul>
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                      ...
                      <p className="mt-2 text-sm text-blue-700">
                        Contact support for assistance with location configuration or check-in issues.
                      </p>
              ...
              <div className="border-b border-gray-200">
                <div className="px-4 py-3">
                  <div className="flex items-center">
                    ...
                    <h3 className="text-md font-medium text-gray-900">Location Information</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-xs text-gray-700">Employees must be physically present within the specified radius to check in.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 h-4 w-4 text-blue-500 mt-0.5">
                    ...
                    <div className="ml-3">
                      <p className="text-xs text-gray-700">GPS coordinates are automatically verified during check-in.</p>
                    </div>
                  </li>
                </ul>
