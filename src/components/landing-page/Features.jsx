...
import { FiMapPin, FiCalendar, FiClock, FiUsers, FiSend, FiBarChart2 } from 'react-icons/fi';
  ...
  const features = [
    {
      ...
      description: "Track attendance with location verification to ensure employees are at the designated workplace."
    },
    {
      icon: <FiCalendar className="h-8 w-8 text-indigo-600" />,
      title: "Leave Management",
      description: "Streamline leave requests, approvals, and track time-off balances with automated workflows."
    },
    {
      icon: <FiClock className="h-8 w-8 text-indigo-600" />,
      title: "Time Tracking",
      description: "Monitor work hours, breaks, and overtime with detailed reporting and insights."
    },
    {
      icon: <FiUsers className="h-8 w-8 text-indigo-600" />,
      title: "Meeting Scheduler",
      description: "Easily coordinate team meetings with availability checking and room booking integration."
    },
    {
      icon: <FiSend className="h-8 w-8 text-indigo-600" />,
      title: "Notifications",
      description: "Automated alerts for pending approvals, schedule changes, and important reminders."
    },
    {
      icon: <FiBarChart2 className="h-8 w-8 text-indigo-600" />,
      title: "Analytics Dashboard",
      description: "Comprehensive reports on attendance patterns, leave trends, and meeting statistics."
    }
  ];
            ...
            >
              <div className={`p-4 rounded-full inline-block mb-4 transition-all duration-300 ${
                ...
                {React.cloneElement(feature.icon, {
                  className: `h-8 w-8 ${
                    hoveredFeature === index ? 'text-indigo-700' : 'text-indigo-600'
                  }`
                })}
              </div>
              ...
              <div className={`w-16 h-1 bg-indigo-600 rounded mt-4 transition-all duration-300 ${
